...
function sldeditor_apply_to_layer(_layerId)
{
	...
	mapFindLayerById(_layerId)._layerObject._sld_body=sldeditor_build_sld(_layerId,sldeditor_create_fullSLD());
	...
	r._data.push({
		...
		_password:mapFindLayerById(_layerId)._serviceObject._password,
		_layerName:mapFindLayerById(_layerId)._layerObject._layerName,
		_sld_body:sldeditor_build_sld(_layerId,sldeditor_create_fullSLD())
	});
