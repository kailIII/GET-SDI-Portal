	...
	public function registerLayer($objArr)
    {
        ...
        if ($p->o_responseCode == 200)
        {
            ...
            else
			{
				...
				$wmtsMatrixSetLinks = $p->xmlNode(str_replace("{_layerName}",(string)$objArr->_layerName,$section["_matrixSetLinks"]));
				...
				for ($a=1;$a<=$wmtsMatrixSetLinks;$a++)
				{
					...
					$wmtsMatrixSet = str_replace("{_layerName}",(string)$objArr->_layerName,$section["_matrixSetLink"]);
					...
					$matrixIds = str_replace("{_layerName}",(string)$objArr->_layerName,$section["_matrixIds"]);
					...
					$martixId = str_replace("{_layerName}",(string)$objArr->_layerName,$section["_matrixId"]);
