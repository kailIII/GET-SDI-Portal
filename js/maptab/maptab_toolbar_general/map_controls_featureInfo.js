...
function map_controls_featureInfo_query()
{
	...
	if (_queryObject.length>0)
	{
		...
		map_controls_featureInfo_request._query=fn_createGetQuery({
			_width:mapGetSize().w,
			_height:mapGetSize().h,
			_x:map_controls_featureInfo_moveEvent_eXY.xy.x,
			_y:map_controls_featureInfo_moveEvent_eXY.xy.y,
		...
		map_controls_featureInfo_request._timeout=5000;
...
function init_map_controls_eastPanel_foundFeaturesGrid()
{
	var featuresPanel={
		...
		region:'center',
		layout:'fit',
		title:_maptab_east_feature_panel,
        ...
        if (layer.div.style.display !== "none")
		{
			...
			{			
				b.push({
					...
					_serviceUrl:layer._serviceObject._serviceUrl,
