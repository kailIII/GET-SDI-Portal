...
function fn_loadedStatus(value, metaData, record, row, col, store, gridView)
{
	...
	{
		case 1:
			output="<img src=\"images/layer_loaded_ok.png\" width=\"16px\" height=\"16px\" data-qtip=\""+_maptab_services_manager_loaded_layer_success_tooltip+"\">";
		break;
		
		case 2:
			output="<img src=\"images/layer_loaded_attention.png\" width=\"16px\" height=\"16px\"  data-qtip=\""+_maptab_services_manager_loaded_layer_attention_tooltip+"\">";
		break;
	}
